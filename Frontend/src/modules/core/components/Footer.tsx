    ...
    <footer className="border-t border-border bg-background">
      <div className="container py-8 md:py-12">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          <div>
            <h3 className="text-lg font-semibold mb-4">BreakIn</h3>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mt-8 pt-8 border-t border-border">
          <p className="text-sm text-muted-foreground">
            © {currentYear} BreakIn. All rights reserved.
          </p>
          <div className="flex space-x-4 mt-4 md:mt-0">
            <Link 
              href="https://twitter.com/breakinplatform" 
            ...
            <Link 
              href="https://github.com/breakin-platform" 
              className="text-muted-foreground hover:text-primary"
              target="_blank" 
              rel="noopener noreferrer"
            >
            ...
            <Link 
              href="https://linkedin.com/company/breakin-platform" 
              className="text-muted-foreground hover:text-primary"
              target="_blank" 
              rel="noopener noreferrer"
            >

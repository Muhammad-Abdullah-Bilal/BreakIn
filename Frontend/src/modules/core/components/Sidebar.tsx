...
export const Sidebar: React.FC<SidebarProps> = ({ variant = 'developer' }) => {
      ...
      return (
        <>
          ...
          <SidebarLink
            ...
            label="Sprints"
            active={pathname?.startsWith('/sprint')}
          />
          <SidebarLink
            href="/workspace"
            icon={
          ...
          <SidebarLink
            ...
            label="Find Mentors"
            active={pathname?.startsWith('/mentor')}
          />
          <SidebarLink
            href="/company"
            icon={
      ...
      return (
        <>
          ...
          <SidebarLink
            ...
            label="Find Talent"
            active={pathname === '/company-dashboard/talent'}
          />
          <SidebarLink
            ...
            label="Manage Jobs"
            active={pathname?.startsWith('/company-dashboard/jobs')}
          />
          <SidebarLink
            ...
            label="Applications"
            active={pathname === '/company-dashboard/applications'}
          />
          <SidebarLink
            ...
            label="Settings"
            active={pathname === '/company-dashboard/settings'}
          />
        </>
      );
      ...
      return (
        <>
          ...
          <SidebarLink
            ...
            label="My Mentees"
            active={pathname?.startsWith('/mentor/mentees')}
          />
          <SidebarLink
      ...
      <div className="flex-1 overflow-auto py-2">
        <div className="px-3 py-2">
          <h2 className="mb-2 px-4 text-lg font-semibold tracking-tight">
            {variant === 'developer' && 'Developer Menu'}
            {variant === 'company' && 'Company Menu'}
            {variant === 'mentor' && 'Mentor Menu'}
          </h2>
